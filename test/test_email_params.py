...
class TestEmailParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EmailParams:
        """Test EmailParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailParams`
        """
        model = EmailParams()
        if include_optional:
            return EmailParams(
