...
class VoidOptionsVoidOptions(BaseModel):
    """
    Information about a transaction that comes to void a previous transaction.
    """ # noqa: E501
    transaction_id: Optional[StrictStr] = Field(default=None, description="ID of the transaction being voided.", alias="transactionId")
