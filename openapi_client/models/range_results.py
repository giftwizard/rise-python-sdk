...
class RangeResults(BaseModel):
    ...
    """ # noqa: E501
    results: Optional[Annotated[List[Dict[str, Any]], Field(max_length=50)]] = Field(default=None, description="List of ranges returned in the same order as requested.")
