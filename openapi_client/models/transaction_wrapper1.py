...
class TransactionWrapper1(BaseModel):
    """
    ...
    created_date: Optional[datetime] = Field(default=None, description="Date and time the Transaction was created.", alias="createdDate")
    __properties: ClassVar[List[str]] = ["id", "createdDate"]
