...
class WALLETACTIONEXCEEDSMAXIMUMBALANCE(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": WALLETACTIONEXCEEDSMAXIMUMBALANCEDetails.from_dict(obj["details"]) if obj.get("details") is not None else None
        })
        return _obj
