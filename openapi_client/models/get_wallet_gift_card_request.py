...
class GetWalletGiftCardRequest(BaseModel):
    """
    
    """ # noqa: E501
    query: Optional[Dict[str, Any]] = Field(default=None, description="Wallet ID, email, or customer reference source by which to retrieve the gift card.")
