...
class ExtendedFields(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExtendedFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExtendedFields from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "namespaces": Namespaces.from_dict(obj["namespaces"]) if obj.get("namespaces") is not None else None
        })
        return _obj
