...
class ReportEventRequest(BaseModel):
    ...
    """ # noqa: E501
    trigger_key: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=100)]] = Field(default=None, description="Trigger key as defined in your app's trigger configuration. For example, `order_returned` or `order_paid`..", alias="triggerKey")
