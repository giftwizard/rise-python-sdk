...
class DeleteCustomerReferenceRequest(BaseModel):
    """
    
    """ # noqa: E501
    query: Optional[Dict[str, Any]] = Field(default=None, description="Query by customer reference source (i.e. source channel, tenant, and customer IDs)")
