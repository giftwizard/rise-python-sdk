...
class RefundTransactionRequest(BaseModel):
    ...
    amount: Optional[StrictStr] = Field(default=None, description="Optional custom amount to refund. If not provided, the full amount of the transaction will be refunded.")
    context: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["transactionId", "amount", "context"]
