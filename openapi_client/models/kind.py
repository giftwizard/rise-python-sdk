...
class Kind(BaseModel):
    ...
    Kind
    """ # noqa: E501
    null_value: Optional[Dict[str, Any]] = Field(default=None, alias="nullValue")
    ...
    list_value: Optional[Dict[str, Any]] = Field(default=None, alias="listValue")
    __properties: ClassVar[List[str]] = ["nullValue", "numberValue", "stringValue", "boolValue", "structValue", "listValue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "structValue": obj.get("structValue"),
            "listValue": obj.get("listValue")
        })
        return _obj
