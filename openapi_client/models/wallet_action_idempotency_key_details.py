...
class WalletActionIdempotencyKeyDetails(BaseModel):
    """
    
    """ # noqa: E501
    wallet_id: Optional[StrictStr] = Field(default=None, description="Wallet Id", alias="walletId")
    idempotency_key: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="Idempotency Key", alias="idempotencyKey")
    __properties: ClassVar[List[str]] = ["walletId", "idempotencyKey"]
