...
class CreateRecipientResponse1(BaseModel):
    """
    
    """ # noqa: E501
    recipient: Optional[Recipient1] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recipient": Recipient1.from_dict(obj["recipient"]) if obj.get("recipient") is not None else None
        })
        return _obj
