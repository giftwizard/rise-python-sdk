...
class UpdatePendingSchedulesPayloadRequest(BaseModel):
    """
    
    """ # noqa: E501
    identifier: Optional[StrictStr] = None
    event_payload: Optional[StrictStr] = Field(default=None, alias="eventPayload")
    __properties: ClassVar[List[str]] = ["identifier", "eventPayload"]
