...
gift_card_order2_instance = GiftCardOrder2.from_json(json)
# print the JSON string representation of the object
print(GiftCardOrder2.to_json())

# convert the object into a dict
gift_card_order2_dict = gift_card_order2_instance.to_dict()
# create an instance of GiftCardOrder2 from a dict
gift_card_order2_from_dict = GiftCardOrder2.from_dict(gift_card_order2_dict)
```
