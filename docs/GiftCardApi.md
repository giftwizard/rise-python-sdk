...
# **create_gift_card**
> CreateGiftCardResponse create_gift_card(gift_card_gift_card_service_v1_rise_gift_cards_post_create_gift_card_request_body)
...
# **decrease_balance**
> DecreaseBalanceResponse decrease_balance(transaction_gift_card_id, gift_card_gift_card_service_v1_rise_gift_cards_transaction_gift_card_id_increase_post_increase_balance_request_body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.decrease_balance(transaction_gift_card_id, gift_card_gift_card_service_v1_rise_gift_cards_transaction_gift_card_id_increase_post_increase_balance_request_body)
...
# **disable_gift_card**
> DisableGiftCardResponse disable_gift_card(gift_card_id, body)
...
# **get_gift_card**
> GetGiftCardResponse get_gift_card(gift_card_id)
...
# **update_gift_card**
> UpdateGiftCardResponse update_gift_card(gift_card_id, gift_card_gift_card_service_v1_rise_gift_cards_gift_card_id_patch_update_gift_card_request_body)
