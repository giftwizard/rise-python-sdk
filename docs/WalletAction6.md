...
**store_credit_context** | [**StoreCreditContext2**](StoreCreditContext2.md) |  | 
**external_event** | [**ExternalEvent2**](ExternalEvent2.md) |  | [optional] 
**wallet_id** | **str** | ID of the wallet to which the WalletAction belongs. | 
...
json = "{}"
# create an instance of WalletAction6 from a JSON string
wallet_action6_instance = WalletAction6.from_json(json)
# print the JSON string representation of the object
print(WalletAction6.to_json())

# convert the object into a dict
wallet_action6_dict = wallet_action6_instance.to_dict()
# create an instance of WalletAction6 from a dict
wallet_action6_from_dict = WalletAction6.from_dict(wallet_action6_dict)
```
