...
# **count_wallets**
> CountWalletsResponse1 count_wallets(wallet_wallet_service_v1_rise_wallets_count_post_count_wallets_request_body)
...
> GetCustomerReferenceResponse1 get_customer_reference(query)
...
> GetOrCreateWalletResponse1 get_or_create_wallet(wallet_wallet_service_v1_rise_wallets_issue_post_get_or_create_wallet_request_body)
...
# **get_wallet**
> GetWalletResponse1 get_wallet(query)
...
# **query_wallets**
> QueryWalletsResponse1 query_wallets(wallet_wallet_service_v1_rise_wallets_query_post_query_wallets_request_body)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.WalletApi(api_client)
    wallet_wallet_service_v1_rise_wallets_query_post_query_wallets_request_body = openapi_client.WalletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody() # WalletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody | 

    try:
        api_response = api_instance.query_wallets(wallet_wallet_service_v1_rise_wallets_query_post_query_wallets_request_body)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **wallet_wallet_service_v1_rise_wallets_query_post_query_wallets_request_body** | [**WalletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody**](WalletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody.md)|  | 
