...
------------ | ------------- | ------------- | -------------
**id** | **str** | WalletAction ID. | [readonly] 
**revision** | **str** | Represents the current state of an item. Each time the item is modified, its &#x60;revision&#x60; changes. For an update operation to succeed, you MUST pass the latest revision. | [readonly] 
...
**store_credit_context** | [**StoreCreditContext1**](StoreCreditContext1.md) |  | [optional] 
...
json = "{}"
# create an instance of WalletAction8 from a JSON string
wallet_action8_instance = WalletAction8.from_json(json)
# print the JSON string representation of the object
print(WalletAction8.to_json())

# convert the object into a dict
wallet_action8_dict = wallet_action8_instance.to_dict()
# create an instance of WalletAction8 from a dict
wallet_action8_from_dict = WalletAction8.from_dict(wallet_action8_dict)
```
