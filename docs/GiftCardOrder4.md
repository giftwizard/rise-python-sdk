...
json = "{}"
# create an instance of GiftCardOrder4 from a JSON string
gift_card_order4_instance = GiftCardOrder4.from_json(json)
# print the JSON string representation of the object
print(GiftCardOrder4.to_json())

# convert the object into a dict
gift_card_order4_dict = gift_card_order4_instance.to_dict()
# create an instance of GiftCardOrder4 from a dict
gift_card_order4_from_dict = GiftCardOrder4.from_dict(gift_card_order4_dict)
```
