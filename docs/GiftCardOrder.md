...
**buyer_info** | **object** | Information about the buyer. | [optional] 
...
**line_items** | **List[object]** | The line items in the order that are Gift Cards. | [optional] 
...
gift_card_order_instance = GiftCardOrder.from_json(json)
# print the JSON string representation of the object
print(GiftCardOrder.to_json())

# convert the object into a dict
gift_card_order_dict = gift_card_order_instance.to_dict()
# create an instance of GiftCardOrder from a dict
gift_card_order_from_dict = GiftCardOrder.from_dict(gift_card_order_dict)
```
