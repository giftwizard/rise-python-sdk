...
json = "{}"
# create an instance of WalletAction1 from a JSON string
wallet_action1_instance = WalletAction1.from_json(json)
# print the JSON string representation of the object
print(WalletAction1.to_json())

# convert the object into a dict
wallet_action1_dict = wallet_action1_instance.to_dict()
# create an instance of WalletAction1 from a dict
wallet_action1_from_dict = WalletAction1.from_dict(wallet_action1_dict)
```
