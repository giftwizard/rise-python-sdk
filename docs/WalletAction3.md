...
json = "{}"
# create an instance of WalletAction3 from a JSON string
wallet_action3_instance = WalletAction3.from_json(json)
# print the JSON string representation of the object
print(WalletAction3.to_json())

# convert the object into a dict
wallet_action3_dict = wallet_action3_instance.to_dict()
# create an instance of WalletAction3 from a dict
wallet_action3_from_dict = WalletAction3.from_dict(wallet_action3_dict)
```
