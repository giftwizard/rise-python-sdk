...
json = "{}"
# create an instance of WalletAction4 from a JSON string
wallet_action4_instance = WalletAction4.from_json(json)
# print the JSON string representation of the object
print(WalletAction4.to_json())

# convert the object into a dict
wallet_action4_dict = wallet_action4_instance.to_dict()
# create an instance of WalletAction4 from a dict
wallet_action4_from_dict = WalletAction4.from_dict(wallet_action4_dict)
```
