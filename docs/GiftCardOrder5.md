...
**revision** | **str** | Revision number, which increments by 1 each time the Order is updated. To prevent conflicting changes, the current revision must be passed when updating the Order.  Ignored when creating a Order. | [readonly] 
...
json = "{}"
# create an instance of GiftCardOrder5 from a JSON string
gift_card_order5_instance = GiftCardOrder5.from_json(json)
# print the JSON string representation of the object
print(GiftCardOrder5.to_json())

# convert the object into a dict
gift_card_order5_dict = gift_card_order5_instance.to_dict()
# create an instance of GiftCardOrder5 from a dict
gift_card_order5_from_dict = GiftCardOrder5.from_dict(gift_card_order5_dict)
```
