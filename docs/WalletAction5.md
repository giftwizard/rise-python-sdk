...
json = "{}"
# create an instance of WalletAction5 from a JSON string
wallet_action5_instance = WalletAction5.from_json(json)
# print the JSON string representation of the object
print(WalletAction5.to_json())

# convert the object into a dict
wallet_action5_dict = wallet_action5_instance.to_dict()
# create an instance of WalletAction5 from a dict
wallet_action5_from_dict = WalletAction5.from_dict(wallet_action5_dict)
```
