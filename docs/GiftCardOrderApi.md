...
# **create_order**
> CreateOrderResponse1 create_order(gift_card_order_gift_card_order_service_v1_rise_orders_post_create_order_request_body)
...
# **update_order**
> UpdateOrderResponse1 update_order(order_id, gift_card_order_gift_card_order_service_v1_rise_orders_order_id_patch_update_order_request_body)
