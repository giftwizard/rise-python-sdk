...
json = "{}"
# create an instance of Transaction2 from a JSON string
transaction2_instance = Transaction2.from_json(json)
# print the JSON string representation of the object
print(Transaction2.to_json())

# convert the object into a dict
transaction2_dict = transaction2_instance.to_dict()
# create an instance of Transaction2 from a dict
transaction2_from_dict = Transaction2.from_dict(transaction2_dict)
```
