...
> CreateWalletActionResponse create_wallet_action(wallet_action_wallet_action_service_v1_rise_wallet_actions_post_create_wallet_action_request_body)
...
> DisableWalletActionResponse disable_wallet_action(wallet_action_id, wallet_action_wallet_action_service_v1_rise_wallet_actions_wallet_action_id_disable_post_disable_wallet_action_request_body)
...
> QueryUnredeemedWalletActionsResponse query_unredeemed_wallet_actions(wallet_action_wallet_action_service_v1_rise_wallet_actions_query_post_query_wallet_actions_request_body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.query_unredeemed_wallet_actions(wallet_action_wallet_action_service_v1_rise_wallet_actions_query_post_query_wallet_actions_request_body)
...
> QueryWalletActionBalancesResponse1 query_wallet_actions_balances(wallet_action_wallet_action_service_v1_rise_wallet_actions_query_post_query_wallet_actions_request_body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.query_wallet_actions_balances(wallet_action_wallet_action_service_v1_rise_wallet_actions_query_post_query_wallet_actions_request_body)
...
> UpdateWalletActionResponse update_wallet_action(wallet_action_id, wallet_action_wallet_action_service_v1_rise_wallet_actions_wallet_action_id_patch_update_wallet_action_request_body)
