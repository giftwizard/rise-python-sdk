...
wallet_action2_instance = WalletAction2.from_json(json)
# print the JSON string representation of the object
print(WalletAction2.to_json())

# convert the object into a dict
wallet_action2_dict = wallet_action2_instance.to_dict()
# create an instance of WalletAction2 from a dict
wallet_action2_from_dict = WalletAction2.from_dict(wallet_action2_dict)
```
